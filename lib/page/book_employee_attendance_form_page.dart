...
class BookEmployeeAttendanceFormPage extends StatefulWidget {
  ...
  const BookEmployeeAttendanceFormPage({
    super.key,
    required this.bookEmployeeAttendance,
  });
...
class _BookEmployeeAttendanceFormPageState
  ...
  void multipleCreate() {
    for (Employee employee in _employees) {
      ...
      createOrUpdateRecord(record).then((value) {
        if (value != null) {
          setState(() {
  ...
  void _destroyRecord(BookEmployeeAttendance line) {
    showConfirmDialog(
      ...
      onSubmit: () {
        _server
            .delete('/book_employee_attendances/${line.id}')
            .then(
              (response) {
                ...
                children: [
                  ...
                  DateRangeFormField(
                    ...
                    onSaved: (newValue) {
                      ...
                      bookEmployeeAttendance.startDate = Date.parsingDateTime(
                        newValue.start,
                      );
                      bookEmployeeAttendance.endDate = Date.parsingDateTime(
                        newValue.end,
                      );
                    },
                    onChanged: (newValue) {
                  ...
                  TextFormField(
                    decoration: const InputDecoration(
                      label: Text('Deskripsi', style: labelStyle),
