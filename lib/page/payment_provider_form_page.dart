  ...
  void fetchPaymentProvider() {
    ...
    server
        .get(
          ...
          queryParam: {'include': 'payment_provider_edcs'},
        )
        .then(
          (response) {
              ...
              children: [
                        ...
                        child: Wrap(
                          ...
                          children: [
                            RadioListTile<PaymentProviderStatus>(
                              title: Text(
                                PaymentProviderStatus.inactive.humanize(),
                              ),
                ...
                SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      const DataColumn(
                        label: Text('Merchant ID', style: labelStyle),
                      ),
                      const DataColumn(
                              ...
                              DataCell(
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    initialValue: paymentProviderEdc.terminalId
                                        .toString(),
                                    keyboardType: TextInputType.number,
                                    onChanged: (value) =>
                                        paymentProviderEdc.terminalId = value,
                                    onSaved: (value) =>
                                        paymentProviderEdc.terminalId =
                                            value ?? '',
                                    key: ValueKey(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () => setState(() {
                      paymentProvider.paymentProviderEdcs.add(
                        PaymentProviderEdc(),
                      );
                    }),
