              ...
              children: [
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      label: Text('Nama Produk', style: labelStyle),
                      isDense: true,
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      label: Text('Default Barcode', style: labelStyle),
                ...
                SizedBox(
                  ...
                  child: AsyncDropdown<Brand>(
                    textOnSearch: (model) =>
                        "${model.name} -  ${model.description}",
                    textOnSelected: (model) => model.name,
                    label: Text('Merek', style: labelStyle),
                    path: 'brands',
                    allowClear: false,
                    isDense: true,
                  ...
                  headerBuilder: (context, isExpanded) => Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Detail Produk', style: labelStyle),
                      ),
                      if (panelPool[0])
                        IconButton.outlined(
                          onPressed: () => setState(() {
                              ...
                              children: [
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: Text('Kategori', style: labelStyle),
                                  ),
                                ),
                                TableCell(
                                  child: Padding(
                        ...
                        return StockKeepingUnitClass()
                            ...
                            .then(
                              (queryResponse) =>
                                  DataTableResponse<StockKeepingUnit>(
                                    totalPage:
                                        queryResponse.metadata['total_pages'] ??
                                        1,
