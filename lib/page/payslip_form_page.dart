        ...
        .then(
          (isSuccess) {
            if (isSuccess) {
              ...
              flash.showBanner(
                title: 'Gagal Simpan',
                description: payslip.errors.join('\n'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        onSaved: (newValue) {
                          payslip.overtimeHour = double.parse(
                            newValue.toString(),
                          );
                        },
                        validator: (newValue) {
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          setState(() {
                                            if (payslipLine.isNewRecord) {
                                              payslip.lines.remove(payslipLine);
                                            } else {
                                              payslipLine.flagDestroy();
                                            }
                                          });
                                        },
