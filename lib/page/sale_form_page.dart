                ...
                children: [
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'notransaksi'),
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'tanggal'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'totalitem'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'subtotal'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'biayalain'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'totalakhir'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'bank_code'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'jmltunai'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'jmldebit'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'jmlemoney'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText: setting.columnName('ipos::Sale', 'ppn'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                            labelText:
                                setting.columnName('ipos::Sale', 'keterangan'),
                            labelStyle: labelStyle,
                            border: const OutlineInputBorder()),
                        readOnly: true,
                        minLines: 3,
