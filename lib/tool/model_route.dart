...
class ModelRoute {
  ...
  static final Map<String, ModelClass> _modelClasses = Map.unmodifiable({
    ...
    'Tagging': TagClass(),
    'Supplier': TagClass(),
    'ProductCategory': TagClass(),
    'Document': TagClass(),
    'Account': TagClass(),
    'Location': TagClass(),
    'Company': TagClass(),
    'StockKeepingUnit': TagClass(),
    'IposPurchaseOrder': TagClass(),
    'IposPurchaseOrderDetail': TagClass(),
    'PurchaseShipment': TagClass(),
    'PurchaseShipmentDetail': TagClass(),
    'OrderCost': TagClass(),
    'PurchaseInvoice': TagClass(),
    'PurchaseInvoiceDetail': TagClass(),
    ...
    'Ipos::IposPurchaseOrder': IposPurchaseOrderClass(),
