...
class ConsignmentIn extends Model {
  ...
  Map<String, dynamic> toMap() => {
    ...
    'consignment_in_order': consignmentInOrder,
  ...
  @override
  String get path => 'ipos/consignment_ins';
  ...
  void setFromJson(Map<String, dynamic> json, {List included = const []}) {
    ...
    if (included.isNotEmpty) {
      ...
      consignmentInOrder = ConsignmentInOrderClass().findRelationData(
        included: included,
