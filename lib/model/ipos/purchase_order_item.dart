...
class IposPurchaseOrderItem extends Model {
  double quantity;
  Item item;
  String itemCode;
  int row;
...
class IposPurchaseOrderItemClass extends ModelClass<IposPurchaseOrderItem> {
  @override
  IposPurchaseOrderItem initModel() => IposPurchaseOrderItem();
}
